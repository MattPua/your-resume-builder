			...
			<div className="max-w-2xl w-full text-center space-y-8 animate-in fade-in zoom-in duration-500">
				...
				<div className="space-y-3">
					...
					<p className="text-lg text-gray-600 dark:text-gray-400 max-w-lg mx-auto">
						Your Resume Builder is a privacy-first resume builder. Your data never leaves your browser.
					</p>
				</div>
					...
					<div className="grid grid-cols-1 gap-2">
						...
						>
							...
							<div className="flex flex-col items-center">
								...
								<span className="text-xs font-normal text-gray-500">Import from text</span>
							</div>
						</Button>
					</div>
				</div>

				<p className="text-xs text-gray-500 dark:text-gray-500 pt-8">
					Already have a resume? Try the Markdown import to quickly bring your data over.
				</p>
			</div>
		</div>
	);
